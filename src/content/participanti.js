...
export default [
    {
        ...
        "logo": "atbbrasov.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/atb.brasov/"],
            ["facebook", "https://www.facebook.com/AsociatiaTinerilorBasarabeniDinBrasov"],
            ["tiktok", "https://www.tiktok.com/@atb_brasov"],
            ["sait", "https://atbbrasov.ro/"],
        ]
    },
    {
        "nume": "Tot mai verde ",
        ...
        "legaturi": [
            ["facebook", "https://www.facebook.com/totmaiverde"],
            ["instagram", "https://www.instagram.com/totmaiverde"]
        ]
    },
    {
        "nume": "Crucea roșie",
    ...
    },
    {
        ...
        "domenii": ["educație", "inovare", "dezvoltare tineret"],
        "logo": "innovation_education_lab.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/innoedulab/"],
            ["sait", "https://linktr.ee/innoedulab"]
        ]
    },
    {
        "nume": "ASAFA",
        ...
        "domenii": ["educație", "leadership", "cultură militară", "comunitate studențească"],
        "logo": "asafa.jpg",
        "legaturi": [
            ["instagram", "https://www.instagram.com/asafabrasov"],
            ["facebook", "https://www.facebook.com/asafabrasov/"],
            ["tiktok", "https://www.tiktok.com/@asafa.brasov"]
        ]
    },
    {
        "nume": "BSPP",
        "descriere": "BSPP oferă studenților FPSE un spațiu sigur pentru dezvoltare academică și personală. Prin activități realizate de studenți pentru studenți, organizația facilitează aplicarea cunoștințelor teoretice, crearea unei comunități de sprijin și organizarea de evenimente educative și culturale care contribuie la formarea profesională, socială și emoțională a membrilor.",
        "domenii": ["educație", "dezvoltare personală", "psihologie și pedagogie"],
        "logo": "bspp.png",
        "legaturi": [
            ["sait", "https://linktr.ee/bspp.fpse"],
            ["instagram", "https://www.instagram.com/bspp.brasov/"],
            ["facebook", "https://www.facebook.com/100087570638448"],
            ["tiktok", "https://www.tiktok.com/@bspp.brasov"]
        ]
    },
    {
        "nume": "BEST ",
        "descriere": "BEST Brașov facilitează comunicarea între Universitatea Transilvania, studenți și companii prin competiții IT, workshop-uri și training-uri. Organizăm evenimente care dezvoltă competențele practice, pregătind studenții pentru piața muncii și oferindu-le oportunități extracurriculare care stimulează creativitatea, gândirea critică și networking-ul cu profesioniști din diverse domenii.",
        "domenii": ["educație tehnică", "dezvoltare profesională", "networking"],
        "logo": "best_brasov.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/bestbrasov"],
            ["linkedin", "https://www.linkedin.com/company/best-brasov/"],
            ["tiktok", "https://www.tiktok.com/@bestbrasov"],
            ["facebook", "https://www.facebook.com/BESTBrasov"],
        ]
    },
    {
        "nume": "Radio Campus Transilvania",
        "descriere": "Radio Campus este platforma media a studenților, oferind experiență practică în producție media, podcasturi și comunicare. Organizăm proiecte care promovează educația, implicarea civică, cultura și dezvoltarea personală. Prin emisiuni și campanii, tinerii dobândesc competențe reale și învață să producă conținut relevant pentru comunitate, dezvoltându-și abilitățile profesionale și sociale",
        "domenii": ["media", "comunicare", "educație"],
        "logo": "radio_campus_transilvania.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/radiocampustransilvania/"],
            ["facebook", "https://www.facebook.com/radiocampustransilvania"],
            ["youtube", "https://www.youtube.com/@radiocampustransilvania"],
            ["sait", "rct.unitbv.ro"],
        ]
    },
    {
        ...
        "legaturi": [
            ["instagram", "https://www.instagram.com/copiii.in.sanul.familiei/"],
            ["facebook", "https://www.facebook.com/CopiiiInSanulFamiliei/"],
            ["sait", "https://www.ascsf.ro/"],
        ]
    },
    {
        ...
        "legaturi": [
            ["sait", "https://educatiepascupas.ro/"]
        ]
    },
    {
        ...
        "logo": "iskon.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/wisdomtalksbv/"]
        ]
    },
    {
        "nume": "Empower Plus",
        "descriere": "Organizația promovează educația non-formală și învățarea continuă pentru tineri și seniori. Prin proiecte locale și europene, inițiative creative și activități practice, Empower Plus stimulează dezvoltarea personală, competențele sociale și implicarea în comunitate, contribuind la crearea unui mediu în care toate generațiile se sprijină și se dezvoltă armonios împreună",
        "domenii": ["educație", "dezvoltare personală", "comunitate"],
        "logo": "empower_plus.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/empower.plus.ngo/"],
            ["facebook", "https://www.facebook.com/100095714674919"]
        ]
    },
    {
        "nume": "ACT Brasov",
        "descriere": "Asociația pentru Acțiune, Comunitate și Tineret – ACT este o organizație care sprijină tinerii să se implice activ în comunitate prin proiecte educaționale, civice și non-formale. ACT facilitează dezvoltarea personală și profesională, oferind oportunități de voluntariat și mobilitate internațională prin programe precum Erasmus+ și European Solidarity Corps, stimulând schimbul de experiențe și competențe interculturale",
        "domenii": ["educație non-formală", "tineret", "voluntariat", "mobilitate internațională", "implicare civică"],
        "logo": "actiune_comunitate_tineret.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/ro.act.ngo/"]
        ]
    },
    {
        "nume": "Zbor Hub Brasov",
        "descriere": " Hub-ul oferă tinerilor între 14 și 24 de ani un spațiu educațional și creativ pentru dezvoltarea personală și profesională. Prin ateliere și workshop-uri pe teme precum antreprenoriat, digitalizare, educație financiară și sustenabilitate, participanții dobândesc competențe practice, descoperă pasiuni noi și învață prin experiență, într-un mediu colaborativ, prietenos și inspirațional",
        "domenii": ["educație", "dezvoltare personală", "antreprenoriat", "tehnologie"],
        "logo": "zbor.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/zborhub.brasov/"]
        ]
    },
    {
        "nume": "Meraki",
        "descriere": "Organizația sprijină adolescenții în construirea încrederii în sine și a unei mentalități pozitive, abordând probleme precum bullying-ul și alimentația sănătoasă. Prin programe educative și activități practice, tinerii învață să-și gestioneze emoțiile, să-și dezvolte abilitățile sociale și să devină responsabili, conștienți de impactul lor asupra propriei sănătăți și comunității",
        "domenii": ["educație", "dezvoltare personală", "sănătate adolescenți"],
        "logo": "meraki.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/meraki.impact.club/"]
        ]
    },
    {
        ...
        "domenii": ["mediu", "ecoturism", "educație montană"],
        "logo": "ism.png",
        "legaturi": [
            ["instagram", "https://www.instagram.com/inslujbamuntelui/"],
            ["facebook", "https://www.facebook.com/inslujbamuntelui"],
            ["tiktok", "https://www.tiktok.com/@inslujbamuntelui"],
            ["sait", "https://linktr.ee/inslujba.muntelui"],
        ]
    },
    {
        ...
        "domenii": ["educație medicală", "chirurgie", "dezvoltare profesională"],
        "logo": "sscr_brasov.jpg",
        "legaturi": [
            ["instagram", "https://www.instagram.com/sscrbrasov/"]
        ]
    }
];
